...
<<<<<<< HEAD
=======
>>>>>>> ea30948282 (Major code refinement and updates.)
=======
...
>>>>>>> 5a71c0a652 (Pathfinding tweaks)
=======
>>>>>>> 6f952b3c47 (Further code cleaning)
...
=======
>>>>>>> d135e66de1 (Garbage Collection)
=======
	src.Destroy()
=======
>>>>>>> 682a229bad (Code update)
	qdel(src)
	return
<<<<<<< HEAD
>>>>>>> d3f4404732 (fixed indents)
=======
...
#undef STATE_CPRBOT_CPR
#undef STATE_CPRBOT_FOLLOWING_OWNER
>>>>>>> 7244c1eb7e (AI pathfinding update)
