...
GLOBAL_LIST_INIT(cm_vending_clothing_synth_snowflake, list(
	...
	list("USCM Engineers Uniform (Darker)", 12, /obj/item/clothing/under/marine/engineer, null, VENDOR_ITEM_REGULAR),
	...
	list("USCM Military Police Uniform (Darker)", 12, /obj/item/clothing/under/marine/mp, null, VENDOR_ITEM_REGULAR),
	...
	list("UA Grey Jumpsuit", 12, /obj/item/clothing/under/colonist/administrator, null, VENDOR_ITEM_REGULAR),
	list("UA Brown Jumpsuit", 12, /obj/item/clothing/under/colonist/steward, null, VENDOR_ITEM_REGULAR),
