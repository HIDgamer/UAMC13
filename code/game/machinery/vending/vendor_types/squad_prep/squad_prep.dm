...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad_prep
	...
	icon_state = "guns"
	req_access = list()
	req_one_access = list(ACCESS_MARINE_LEADER, ACCESS_MARINE_PREP)
	hackable = TRUE
...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/populate_product_list(scale)
	listed_products = list(
		...
		list("Firearm Lubricant", floor(scale * 15), /obj/item/stack/repairable/gunlube, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/alpha
	req_access = list(ACCESS_MARINE_PREP)
	req_one_access = list(ACCESS_MARINE_ALPHA, ACCESS_MARINE_LEADER, ACCESS_MARINE_CARGO)
...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/bravo
	req_access = list(ACCESS_MARINE_PREP)
	req_one_access = list(ACCESS_MARINE_BRAVO, ACCESS_MARINE_LEADER, ACCESS_MARINE_CARGO)
...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/charlie
	req_access = list(ACCESS_MARINE_PREP)
	req_one_access = list(ACCESS_MARINE_CHARLIE, ACCESS_MARINE_LEADER, ACCESS_MARINE_CARGO)
...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/delta
	req_access = list(ACCESS_MARINE_PREP)
	req_one_access = list(ACCESS_MARINE_DELTA, ACCESS_MARINE_LEADER, ACCESS_MARINE_CARGO)
...
/obj/structure/machinery/cm_vending/sorted/attachments/squad/populate_product_list(scale)
	listed_products = list(
		...
		list("Micro Laser Sight", 1.5, /obj/item/attachable/lasersight/micro, VENDOR_ITEM_REGULAR),
